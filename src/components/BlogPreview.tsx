...
const blogPosts = [
  {
    ...
    excerpt: 'Como a Internet das Coisas está transformando processos industriais e criando fábricas inteligentes.',
  ...
  },
  {
    ...
    excerpt: 'Como robôs colaborativos ajudam equipes a trabalhar com mais precisão, segurança e produtividade.',
...
const BlogPreview = () => {
  return (
    <section className="relative bg-[#0D0F52] py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="text-lg text-gray-400">
            Artigos técnicos e ideias sobre IoT, robótica e sistemas embarcados.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            <article
              key={post.title}
              className="group relative overflow-hidden rounded-md border border-[#159AFD]/30 bg-[#0D0F52]/40 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:border-[#159AFD]/60"
            >
              <div className="relative">
                ...
                <div className="absolute left-4 top-4">
                  <span className="rounded-md border border-[#159AFD]/30 bg-[#159AFD]/90 px-4 py-2 text-sm font-semibold text-white backdrop-blur-sm">
                    {post.category}
                  </span>
                </div>
              </div>
