...
const copy = {
  pt: {
    ...
    admin: 'Administrador',
    adminText: 'Responsável por organizar clientes, projetos, valores, técnicos, atualizações OTA e entregas dentro do painel administrativo.',
  ...
  en: {
    ...
    admin: 'Administrator',
    adminText: 'Responsible for organizing clients, projects, values, technicians, OTA updates and deliveries inside the admin panel.',
  ...
  es: {
    ...
    admin: 'Administrador',
    adminText: 'Responsable de organizar clientes, proyectos, valores, técnicos, actualizaciones OTA y entregas dentro del panel administrativo.',
